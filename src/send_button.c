...
static void add_message(t_main *m, t_user *i) {
    ...
    // g_notification_set_body (notification, "Check this");
    // g_application_send_notification(G_APPLICATION(gtk_window_get_application(GTK_WINDOW(i->m->window))), "Message!", notification);
