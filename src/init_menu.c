...
void init_menu(t_main *m) {
    ...
    m->menu->flag = 0;
    m->menu->setic = gtk_image_new_from_file("./source/resource/setic.png"); 
    m->menu->setic2 = gtk_image_new_from_file("./source/resource/setic2.png"); 
    m->menu->searchic = gtk_image_new_from_file("./source/resource/searchic.png"); 
    m->menu->searchic2 = gtk_image_new_from_file("./source/resource/searchic2.png"); 
    m->menu->exic = gtk_image_new_from_file("./source/resource/exic.png"); ;
    m->menu->exic2 = gtk_image_new_from_file("./source/resource/exic2.png"); ;
    m->menu->contic = gtk_image_new_from_file("./source/resource/contic.png");
    m->menu->contic2 = gtk_image_new_from_file("./source/resource/contic2.png");
    m->menu->blackic = gtk_image_new_from_file("./source/resource/blackic.png");
    m->menu->blackic2 = gtk_image_new_from_file("./source/resource/blackic2.png");
    stic_and_fix(m);
}
